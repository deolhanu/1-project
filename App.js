...
return(
  <div className ="header">
    <div className="logo-container">
      <img className="logo" src="https://www.foodiesfeed.com/wp-content/uploads/2019/06/top-view-for-box-of-2-burgers-home-made-684x1024.jpg"/>
      </div>
    <div className = "Items">
      <ul>
  ...
  return (
    <div className="body">
      ...
      <div className ="res-con">
        <RestaurantCards resName = {resList[0]} />  
        <RestaurantCards resName = {resList[1]} /> 
        <RestaurantCards resName = {resList[2]} /> 
        <RestaurantCards resName = {resList[3]} /> 
       </div>
